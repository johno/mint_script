  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved script as @script" do
        ...
        post :create, {:script => { "title" => "invalid value" }}, valid_session
        assigns(:script).should be_a_new(Script)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested script" do
        ...
        Script.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => script.to_param, :script => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the script as @script" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Script.any_instance.stub(:save).and_return(false)
        put :update, {:id => script.to_param, :script => { "title" => "invalid value" }}, valid_session
        assigns(:script).should eq(script)
      end
